...
const GetPhotoBySectionCorporation = () => {
    ...
    useEffect(() => {
        fetchGalleriesByType('CORPORATION')
    }
        , [])
    ...
    return (
        ...
        loading ? <p className=" w-[100%] flex  flex-col justify-center items-center h-screen" >loading....</p> : galleriesByType?.data?.content.length === 0 ? <p className=" w-[100%] flex  flex-col justify-center items-center h-screen">No data</p> :
            ...
            <>
                <Breadcrumb />
                <div className=" grid grid-cols-1 text-center md:w-[800px] lg:w[800px]   h-full  w-[100%] gap-7 md:grid md:grid-cols-2 lg:grid-cols-3  lg:items-center px-[20px]">
...
export default GetPhotoBySectionCorporation